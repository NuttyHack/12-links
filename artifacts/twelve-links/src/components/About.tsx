...
export default function About() {
  ...
  const team = [
    ...
    { name: "Mageza L.", role: "Cybersecurity Engineer & CFO", bio: "Securing the platform's infrastructure, mitigating vulnerabilities, and protecting core user data from modern cyber threats.", color: "from-purple-500 to-violet-700" , image: "/team/lesego-mageza.jpeg" },
    { name: "George L.", role: "Security Architect & COO", bio: "Designing robust end-to-end security frameworks and governance protocols to ensure ultimate platform compliance and integrity.", color: "from-pink-500 to-rose-700" , image: "/team/ghost.jpeg" },
    { name: "Mpayipheli S.", role: "Software Developer & HOP", bio: "Building responsive, seamless, and highly interactive client-side applications that deliver an exceptional user experience.", color: "from-red-500 to-orange-600" , image: "/team/sairo.jpg" },
    { name: " Aphane S.", role: "Data Scientist & CMO", bio: "Extracting actionable insights from complex datasets and building predictive models to optimize platform growth and user engagement.", color: "from-teal-500 to-green-700" , image: "/team/zila.jpg" }
  ];
